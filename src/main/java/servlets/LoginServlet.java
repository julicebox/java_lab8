...
// восстановить имя через cookie
        ...
        // Вывести форму
        pw.println("<form action='/Java-Lab-8/' method='post'>Enter name:" +
                "<input type='text' name='name' value=''><input type='submit' value='Enter " + "chat'>");
